...
export interface FiltrosTiposComprobanteValores {
  nombre: string
  estado: string
}

interface FiltrosTiposComprobanteProps {
  valores: FiltrosTiposComprobanteValores
  onChange: (
    campo: keyof FiltrosTiposComprobanteValores,
    valor: string,
  ) => void
  onBuscar: () => void
  onLimpiar: () => void
...
export function FiltrosTiposComprobante({
  valores,
  onChange,
  onBuscar,
  onLimpiar,
}: FiltrosTiposComprobanteProps) {
      ...
      <div className="card-body p-3 p-lg-3">
        ...
        <div className="row g-3">
          <div className="col-12 col-lg-8">
            ...
            <input
              id="nombreTipoComprobante"
              className="form-control maestro-control"
              type="text"
              value={valores.nombre}
              placeholder="Ej. Factura, Boleta, Nota de crédito"
              onChange={(event) =>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <label className="form-label maestro-label" htmlFor="estadoTipoComprobante">
              Estado
            </label>
