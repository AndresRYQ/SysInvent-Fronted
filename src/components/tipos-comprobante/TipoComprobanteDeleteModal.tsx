...
export function TipoComprobanteDeleteModal({
  ...
  if (!abierto || !tipoComprobante) return null
  ...
  return (
    <div className="maestro-modal-backdrop" role="presentation">
      ...
      >
        ...
        <h3 id="tipo-comprobante-delete-title" className="maestro-modal-title text-center">
        ...
        <p className="maestro-delete-name">{tipoComprobante.nombre}</p>
