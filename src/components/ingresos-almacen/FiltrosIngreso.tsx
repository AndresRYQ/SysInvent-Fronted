...
export interface FiltrosIngresoValores {
  numeroIngreso: string
  proveedor: string
  estado: string
}

interface FiltrosIngresoProps {
  valores: FiltrosIngresoValores
  onChange: (
    campo: keyof FiltrosIngresoValores,
    valor: string,
  ) => void
  onBuscar: () => void
  onLimpiar: () => void
...
export function FiltrosIngreso({
  valores,
  onChange,
  onBuscar,
  onLimpiar,
        ...
        <div className="row g-3">
          <div className="col-12 col-lg-4">
            ...
            <input
              ...
              onChange={(event) =>
                onChange('numeroIngreso', event.target.value)
              }
            />
          </div>
          ...
          <div className="col-12 col-lg-5">
            ...
            <input
              ...
              onChange={(event) =>
                onChange('proveedor', event.target.value)
              }
            />
          </div>
