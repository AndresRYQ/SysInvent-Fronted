      ...
      <div className="maestro-modal-card" role="dialog" aria-modal="true" aria-labelledby="categoria-form-title">
        ...
        <form noValidate onSubmit={(event) => {
          ...
          <div className="maestro-modal-body">
            ...
            <div className="mb-3">
              <label className="form-label" htmlFor="categoriaNombreModal">Nombre de la categoría{!soloLectura && <span className="maestro-required">*</span>}</label>
            ...
            <div>
              <label className="form-label" htmlFor="categoriaDescripcionModal">Descripción{!soloLectura && <span className="maestro-required">*</span>}</label>
