...
export interface FiltrosUnidadesMedidaValores {
  nombre: string
  estado: string
}

interface FiltrosUnidadesMedidaProps {
  valores: FiltrosUnidadesMedidaValores
  onChange: (
    campo: keyof FiltrosUnidadesMedidaValores,
    valor: string,
  ) => void
  onBuscar: () => void
  onLimpiar: () => void
...
export function FiltrosUnidadesMedida({
  valores,
  onChange,
  onBuscar,
  onLimpiar,
}: FiltrosUnidadesMedidaProps) {
  return (
      ...
      <div className="card-body p-3 p-lg-3">
        ...
        <div className="row g-3">
          <div className="col-12 col-lg-8">
            <label className="form-label maestro-label" htmlFor="nombreUnidadMedida">
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <label className="form-label maestro-label" htmlFor="estadoUnidadMedida">
              Estado
            </label>

            <MaestroEstadoSelect
              inputId="estadoUnidadMedida"
              value={valores.estado}
              onChange={(value) => onChange('estado', value)}
            />
            {/*
              <select
                id="estadoUnidadMedida"
